...
## Project Structure
    ...
    ├── testapiautocatalog_128011  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_128011`
...
2. Clone this repo and `cd testapiautocatalog_128011`
